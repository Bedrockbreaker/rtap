...
import com.bedrock.rtap.init.ModDeath;
import com.bedrock.rtap.init.ModEvents;
import com.bedrock.rtap.init.ModItems;
import com.bedrock.rtap.init.ModLootTables;
import com.bedrock.rtap.init.ModNonCrafting;
import com.bedrock.rtap.init.ModSoundHandler;
import com.bedrock.rtap.init.ModTools;
import com.bedrock.rtap.irecipes.sulfur;
import com.bedrock.rtap.proxy.CommonProxy;
...
public class RTAP {
	...
	@EventHandler //Items, Blocks
	public void preInit(FMLPreInitializationEvent event) {
		
		ModBlocks.init(); //Moved to initialize croppeppers before foodpeppers
		ModBlocks.register();
		ModItems.init();
		ModItems.register();
		ModTools.init();
	 ...
	 * 
	 * * Add all the different types of ramen. There's like 10 I think? They all have different potion effects.
	 * ! FIX SOUNDS!!
	 * - Make itemliquidmeat use sulfur instead of gunpowder. filter + gunpowder?
	 * * FIX LOOT TABLES AGHHHHHH!
	 * ! Create jello freezer. Make sure it can be automated with pipes/hoppers. Make it use rf. Internal fuel can be used if no other rf producing mod exists. Config option available.
	 ...
	 * * Add Main tools, armor, dimension for combination of all techs.
